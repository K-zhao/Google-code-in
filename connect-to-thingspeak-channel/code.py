...
while True:
    ...
    result_temp = json.loads(temperatureURL)
    result_hmd = json.loads(humidityURL)
    ...
    print("Latest data from Thingspeak:", date, time, "Temperature:", result_temp["field1"], "C", "Humidity:", result_hmd["field2"], "%")
    time.sleep(2)