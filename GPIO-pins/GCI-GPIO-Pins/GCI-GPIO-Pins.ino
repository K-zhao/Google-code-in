...
void loop()
{
    ...
    // To be used for printing on LCD
    ...
    // Sets the cursor to column 0, line 0 (LCD)
    lcd.setCursor(0, 0);
    ...
    // Prints whether the light sensor is detecting alot or little light in the serial monitor and LCD (Photoresistor)
    switch (range) 
    {
        case 0:
            Serial.println("dark");
